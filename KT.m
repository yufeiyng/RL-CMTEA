function offspring = KT(Algo, Prob, population, divK, divD)
    corre = [];
    ...
    for i = 1:size(off_corre, 1)
        ...
        offspring{data_seq(1)}(data_seq(2)).Dec(data_seq(3):data_seq(4)) = offspring_temp(i, 1:data_seq(4) - data_seq(3) + 1);
    end
